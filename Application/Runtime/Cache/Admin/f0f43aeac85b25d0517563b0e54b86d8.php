...
<?php if($admin['level'] === '0'): ?><li>
    ...
    <?php if($admin['level'] === '0'): ?><li>
            <a    href="/book/Admin/Index/index_set.html">
                <i class="menu-icon fa fa-fw fa-gears"></i>
                <span class="menu-text">网站主页设置</span>
            </a>
            <b class="arrow"></b>
        </li><?php endif; ?>
...
<div class="actions-bar clearfix" style="margin-top: 15px;">
    ...
    <ul class="nav nav-pills nav-pills-sm pull-left" style="margin-top: 3px;">
        <li class="active"><a href="/book/Admin/Book/book_list.html">全部</a></li>
        <li class="active"><a href="/book/Admin/Book/book_list?sex=1">男频</a></li>
        <li class="active"><a href="/book/Admin/Book/book_list?sex=2">女频</a></li>
        <li class="active"><a href="/book/Admin/Book/book_list?state=0">连载</a></li>
        <li class="active"><a href="/book/Admin/Book/book_list?state=1">完结</a></li>
         <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vt): $mod = ($i % 2 );++$i;?><li class="active"> <a href="/book/Admin/Book/book_list?tid=<?php echo ($vt["id"]); ?>"><?php echo ($vt["name"]); ?></a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
</div>
...
<table class="table table-striped table-bordered responsive table-hover" id="dataTables-example">
    ...
    <tbody>
        <?php if(is_array($books)): $i = 0; $__LIST__ = $books;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vb): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
            <td class="text-center">
                <img src="/book/Public/Uploads/book/<?php echo ($vb["img"]); ?>" width="50" height="65">
            </td>
            <td>
                <a    href="/book/Admin/Book/book_share?bid=<?php echo ($vb["id"]); ?>">[<?php echo ($vb["name"]); ?>] <?php echo ($vb["title"]); ?></a>
            ...
            <td>
                <a data-nid="35" data-toggle="set-offline" title="" class="btn btn-success btn-xs" >
                        已上架
                </a>
            </td>
            <?php if($vb['sex'] === '1'): ?><td class="text-center">男频</td>
            <?php else: ?>
            <td class="text-center">女频</td><?php endif; ?>
            <!-- <td class="text-center">100</td> -->
            <td class="text-center">
                <?php if($admin['level'] === '0'): ?><a href="/book/Admin/Book/edit_book?id=<?php echo ($vb["id"]); ?>" class="btn">编辑书籍</a>&nbsp;&nbsp;
                    <?php if($vb['show'] === '1'): ?><a href="/book/Admin/Book/book_doshow?id=<?php echo ($vb["id"]); ?>" class="btn">设为推荐</a>&nbsp;&nbsp;
                    <?php else: ?>
                    <a href="/book/Admin/Book/book_doshow?id=<?php echo ($vb["id"]); ?>" class="btn">取消推荐</a>&nbsp;&nbsp;<?php endif; ?>
                    <?php if($vb['hot'] === '1'): ?><a href="/book/Admin/Book/book_dohot?id=<?php echo ($vb["id"]); ?>" class="btn">设为热门</a>&nbsp;&nbsp;
                    <?php else: ?>
                    <a href="/book/Admin/Book/book_dohot?id=<?php echo ($vb["id"]); ?>" class="btn">取消热门</a>&nbsp;&nbsp;<?php endif; ?>
                    <?php if($vb['eic'] === '1'): ?><a href="/book/Admin/Book/book_doeic?id=<?php echo ($vb["id"]); ?>" class="btn">设为编辑推荐</a>&nbsp;&nbsp;
                    <?php else: ?>
                    <a href="/book/Admin/Book/book_doeic?id=<?php echo ($vb["id"]); ?>" class="btn">取消编辑推荐</a>&nbsp;&nbsp;<?php endif; ?>
                    <a href="/book/Admin/Book/del_book?id=<?php echo ($vb["id"]); ?>" class="btn">删除</a>&nbsp;&nbsp;<?php endif; ?>
            </td>
