...
<head>
    ...
    <script type="text/javascript" src="/book/Public/home/js/jquery.min.js"></script>
...
<script>
    ...
    $(function(){
        $("#tabbar div").off("click").on("click",function(){
            var index = $(this).index();
            $(this).addClass("on").siblings().removeClass("on");
            var content = "/book/Home/Index/index.html";
            if (index == 1) {
                content = "/book/Home/Book/book_type_v1.html";
            } else if (index == 2) {
                content = "/book/Home/Index/recharge.html";
            } else if (index == 3) {
                content = "/book/Home/User/center.html";
            }
